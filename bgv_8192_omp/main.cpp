...
int main() {
	...
	cout << " Reading query data ... ok" << endl;
...
#pragma omp parallel for
	...
	cout << " Encoding and encrypting query data ... ok" << endl;
	...
	cout << " Reading database  data ... ok" << endl;
	/*�и����*/
	// print_line(__LINE__);
	...
	cout << " Encoding and encrypting database data ... ok" << endl;
